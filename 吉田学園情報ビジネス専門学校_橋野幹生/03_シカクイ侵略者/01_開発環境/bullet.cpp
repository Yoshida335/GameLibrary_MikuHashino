...
#define BULLET_WIDTH		(30.0f)		//弾のサイズ
#define BULLET_HEIGHT		(30.0f)		//弾のサイズ
...
void InitBullet(void)
{
	...
	for (nCntBullet = 0; nCntBullet < MAX_BULLET; nCntBullet++)
	{
		...
		pVtx[2].pos.x = g_aBullet[nCntBullet].pos.x + sinf(g_aBullet[nCntBullet].rot.z + (0.0f - g_fAngleBullet)) * g_fLengthBullet;
		pVtx[2].pos.y = g_aBullet[nCntBullet].pos.y + cosf(g_aBullet[nCntBullet].rot.z + (0.0f - g_fAngleBullet)) * g_fLengthBullet;
		pVtx[2].pos.z = 0.0f;

		pVtx[3].pos.x = g_aBullet[nCntBullet].pos.x + sinf(g_aBullet[nCntBullet].rot.z + (0.0f + g_fAngleBullet)) * g_fLengthBullet;
		pVtx[3].pos.y = g_aBullet[nCntBullet].pos.y + cosf(g_aBullet[nCntBullet].rot.z + (0.0f + g_fAngleBullet)) * g_fLengthBullet;
		pVtx[3].pos.z = 0.0f;*/
