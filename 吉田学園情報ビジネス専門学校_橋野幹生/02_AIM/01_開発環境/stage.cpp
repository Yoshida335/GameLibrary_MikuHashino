...
void Stage(STAGE_No nSelect)
{
	...
	case STAGE_No_0:
		...
		//１段目
		SetBlock(D3DXVECTOR3(800.0f, 560.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 25, BLOCK_HEIGHT * 1, 2);
		SetBlock(D3DXVECTOR3(80.0f, 560.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 7, BLOCK_HEIGHT * 1, 2);

		SetBlock(D3DXVECTOR3(200.0f, 480.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 1, BLOCK_HEIGHT * 4, 2);
		SetBlock(D3DXVECTOR3(900.0f, 490.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 1, BLOCK_HEIGHT * 3, 2);

		//２段目
		SetBlock(D3DXVECTOR3(360.0f, 420.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 8, BLOCK_HEIGHT * 1, 2);
		SetBlock(D3DXVECTOR3(660.0f, 420.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 3, BLOCK_HEIGHT * 1, 2);
		SetBlock(D3DXVECTOR3(860.0f, 420.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 3, BLOCK_HEIGHT * 1, 2);
		SetBlock(D3DXVECTOR3(1100.0f, 420.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 3, BLOCK_HEIGHT * 1, 2);

		SetBlock(D3DXVECTOR3(660.0f, 350.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 1, BLOCK_HEIGHT * 3, 2);

		//３段目
		SetBlock(D3DXVECTOR3(180.0f, 280.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 12, BLOCK_HEIGHT * 1, 2);
		SetBlock(D3DXVECTOR3(860.0f, 280.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 11, BLOCK_HEIGHT * 1, 2);
		SetBlock(D3DXVECTOR3(1260.0f, 280.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 5, BLOCK_HEIGHT * 1, 2);
		SetBlock(D3DXVECTOR3(600.0f, 280.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 5, BLOCK_HEIGHT * 1, 2);

		SetBlock(D3DXVECTOR3(280.0f, 140.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 1, BLOCK_HEIGHT * 7, 2);
		SetBlock(D3DXVECTOR3((SCREEN_WIDTH - 220.0f), 300.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 1, BLOCK_HEIGHT * 7, 2);

		//4段目
		SetBlock(D3DXVECTOR3(1180, 140.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 7, BLOCK_HEIGHT * 1, 2);
		SetBlock(D3DXVECTOR3(60.0f, 140.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 6, BLOCK_HEIGHT * 1, 2);
		SetBlock(D3DXVECTOR3(620, 140.0f, 0.0f), BLOCKTYPE_NOMAL, BLOCKSTATE_NOMAL, BLOCK_WIDTH * 17, BLOCK_HEIGHT * 1, 2);
		...
		for (int i = 0; i < 2; i++)
		{
			SetBlock(D3DXVECTOR3(980.0f + (i * BLOCK_WIDTH), 140.0f, 0.0f),
				BLOCKTYPE_UP,
				BLOCKSTATE_NOMAL,
				BLOCK_WIDTH,
				BLOCK_HEIGHT * 1,
		...
		for (int i = 0; i < 2; i++)
		{
			SetBlock(D3DXVECTOR3(440.0f + (i * BLOCK_WIDTH), 280.0f, 0.0f),
				BLOCKTYPE_UP,
				BLOCKSTATE_NOMAL,
				BLOCK_WIDTH,
				BLOCK_HEIGHT * 1,
		...
		for (int i = 0; i < 2; i++)
		{
			SetBlock(D3DXVECTOR3(1100.0f + (i * BLOCK_WIDTH), 280.0f, 0.0f),
				BLOCKTYPE_UP,
				BLOCKSTATE_NOMAL,
				BLOCK_WIDTH,
				BLOCK_HEIGHT * 1,
		...
		for (int i = 0; i < 2; i++)
		{
			SetBlock(D3DXVECTOR3(540.0f + (i * BLOCK_WIDTH), 420.0f, 0.0f),
				BLOCKTYPE_UP,
				BLOCKSTATE_NOMAL,
				BLOCK_WIDTH,
				BLOCK_HEIGHT * 1,
		...
		for (int i = 0; i < 2; i++)
		{
			SetBlock(D3DXVECTOR3(740.0f + (i * BLOCK_WIDTH), 420.0f, 0.0f),
				BLOCKTYPE_UP,
				BLOCKSTATE_NOMAL,
				BLOCK_WIDTH,
				BLOCK_HEIGHT * 1,
		...
		for (int i = 0; i < 2; i++)
		{
			SetBlock(D3DXVECTOR3(240.0f + (i * BLOCK_WIDTH), 560.0f, 0.0f),
				BLOCKTYPE_UP,
				BLOCKSTATE_NOMAL,
				BLOCK_WIDTH,
				BLOCK_HEIGHT * 1,
		...
		//アイテム -----------------------------------
		SetItem(D3DXVECTOR3(225.0f, 140.0f, 0.0f), ITEM_TYPE_0);
		SetItem(D3DXVECTOR3(1200.0f, 220.0f, 0.0f), ITEM_TYPE_0);
		SetItem(D3DXVECTOR3(280.0f, 360.0f, 0.0f), ITEM_TYPE_0);
		SetItem(D3DXVECTOR3(50.0f, 640.0f, 0.0f), ITEM_TYPE_0);
		SetItem(D3DXVECTOR3(990.0f, 420.0f, 0.0f), ITEM_TYPE_0);
